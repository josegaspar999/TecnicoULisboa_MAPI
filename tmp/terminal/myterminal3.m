function varargout = myterminal3(varargin)

% myterminal3 MATLAB code for myterminal3.fig
%      myterminal3, by itself, creates a new myterminal3 or raises the existing
%      singleton*.
%
%      H = myterminal3 returns the handle to a new myterminal3 or the handle to
%      the existing singleton*.
%
%      myterminal3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in myterminal3.M with the given input arguments.
%
%      myterminal3('Property','Value',...) creates a new myterminal3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before myterminal3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to myterminal3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help myterminal3

% Last Modified by GUIDE v2.5 21-Mar-2020 15:13:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @myterminal3_OpeningFcn, ...
                   'gui_OutputFcn',  @myterminal3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before myterminal3 is made visible.
function myterminal3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to myterminal3 (see VARARGIN)

% Choose default command line output for myterminal3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes myterminal3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = myterminal3_OutputFcn(hObject, eventdata, handles)
...
myterminal3_aux( 'set_coils', 0, get(hObject,'Value') );
...
myterminal3_aux( 'set_coils', 1, get(hObject,'Value') );
...
myterminal3_aux( 'set_coils', 2, get(hObject,'Value') );
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
myterminal3_aux( 'refresh', hObject, handles );
