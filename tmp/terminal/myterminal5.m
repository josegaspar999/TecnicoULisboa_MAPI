function varargout = myterminal5(varargin)

% myterminal5 MATLAB code for myterminal5.fig
%      myterminal5, by itself, creates a new myterminal5 or raises the existing
%      singleton*.
%
%      H = myterminal5 returns the handle to a new myterminal5 or the handle to
%      the existing singleton*.
%
%      myterminal5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in myterminal5.M with the given input arguments.
%
%      myterminal5('Property','Value',...) creates a new myterminal5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before myterminal5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to myterminal5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help myterminal5

% Last Modified by GUIDE v2.5 18-Apr-2020 00:59:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @myterminal5_OpeningFcn, ...
                   'gui_OutputFcn',  @myterminal5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before myterminal5 is made visible.
function myterminal5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to myterminal5 (see VARARGIN)

% Choose default command line output for myterminal5
...
% myterminal5_aux('options', 'set', 'hObject', hObject); % not needed
myterminal5_aux('options', 'set', 'handles', handles);

% UIWAIT makes myterminal5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = myterminal5_OutputFcn(hObject, eventdata, handles)
...
% disp('mymenu')
myterminal5_aux( 'mymenu', hObject, handles );
...
myterminal5_aux( 'set_coils', 0, get(hObject,'Value') );
...
myterminal5_aux( 'set_coils', 1, get(hObject,'Value') );
...
myterminal5_aux( 'set_coils', 2, get(hObject,'Value') );
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
myterminal5_aux( 'refresh', hObject, handles );
