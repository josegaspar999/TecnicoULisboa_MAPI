function [A,RM] = reach_graph_pri(Pre,Post,M0,PrioT)
% [A,RM] = reach_graph_pri(Pre,Post,M0,PrioT)
% function reach_graph_pri finds a graph of reachable markings to given marked bounded Priority Petri Net
